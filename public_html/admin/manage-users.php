                                        ...
                                        "<tr>
                                            ...
                                            <td class='text-center'>
                                                <form action='manage-users.php' id='{$user["user_id"]}' method='post'>
                                                    ...
                                                    <a type='button' data-bs-toggle='modal' data-bs-target='#static' value='{$user["user_id"]}' 
                                                    onclick='updateModal({$user["user_id"]});' class='h4'>
                                    ...
                                    foreach ($customerUsers as $user) {
                                        ...
                                        "<tr>
                                            ...
                                            <td class='text-center'>
                                                <form action='manage-users.php' id='{$user["user_id"]}' method='post'>
                                                    <input type='hidden' name='user_id' value='{$user["user_id"]}'>
                                                    <a type='button' data-bs-toggle='modal' data-bs-target='#static' onclick='updateModal({$user["user_id"]});' class='h4'>
                                                    <i class='bi bi-trash'></i></a>
                                                </form>    
                                            </td>
                                        </tr>";
                        ...
                        <div class='modal-dialog'>
                            <div class='modal-content'>
                                ...
                                <div class='modal-body bg-warning-subtle'>
                                    <p class="fw-bolder">Warning: This action cannot be reversed! <br>Proceed with caution.</p>
                                </div>
                                <div class='modal-footer'>
                                    <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Close</button>
                                    <button type='submit' id="modal-btn" form="" class='btn btn-primary'>I understand</button>
                                </div>
                            </div>
                        </div>
                    </div>
